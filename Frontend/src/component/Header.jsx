...
function Header() {
    ...
    const searchToggleValue = searchToggle.movieSlice.
        toggleSearch
    ...
    const searchHandler = async () => {
        dispatch(setToggleSearch(!searchToggle.movieSlice.
            toggleSearch))
    }
    return (
        <>
                ...
                {/* </NavLink> */}
                {
                    userExist ? <div className='flex justify-between items-center gap-5'>
                        ...
                        <div className='flex gap-5'>
                            ...
                            <button className='text-white px-4 py-2 bg-red-800 font-bold gap-5  cursor-pointer' onClick={searchHandler}>{searchToggleValue ? "Home" : "Search Movie"}</button>
                        </div>
                    </div> :
